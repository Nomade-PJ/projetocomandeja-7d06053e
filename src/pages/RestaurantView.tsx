...
import { ShoppingCart, Star, Clock, MapPin, Search, Phone, Instagram, Facebook, ChevronDown, Info, Heart } from "lucide-react";
...
const RestaurantView = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-3 text-white">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-3">
                  <button className="p-2 rounded-full bg-white/20 hover:bg-white/30 backdrop-blur-md">
                    <Heart className="w-5 h-5 text-white" />
                  </button>
                  <button className="p-2 rounded-full bg-white/20 hover:bg-white/30 backdrop-blur-md relative">
      ...
      {/* Barra de Pesquisa - ajustada para ficar no topo após remover o header */}
              ...
              {categoryProducts.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {categoryProducts.map((product) => (
                    <Card key={product.id} className="overflow-hidden hover:shadow-lg transition-shadow group border border-gray-200">
                      {product.image_url ? (
      ...
      {/* Footer - ajustado para remover o margin-top extra */}
